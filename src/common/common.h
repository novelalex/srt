...
// Compiler detection
    ...
    #define NB_COMPILER_VERSION (__clang_major__ * 10000 + __clang_minor__ * 100 + __clang_patchlevel__)
#elif defined(__GNUC__)
    #define NB_COMPILER_GCC 1
    #define NB_COMPILER_NAME "GCC"
    #define NB_COMPILER_VERSION (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#else
