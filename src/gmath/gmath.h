...
static inline Quaternion gm_quaternion_from_angle_axis(f32 angle_radians,
                                                       Vector3 axis);
...
static inline void gm_quaternion_to_angle_axis(Quaternion q, f32 *out_angle,
                                               Vector3 *out_axis);
...
static inline Matrix4 gm_matrix4_shearing(f32 xy, f32 xz, f32 yx, f32 yz,
                                          f32 zx, f32 zy);
...
static inline void gm_matrix4_mult_out(Matrix4 *out, const Matrix4 *a,
                                       const Matrix4 *b);

static inline bool gm_matrix4_equal(const Matrix4 *a, const Matrix4 *b,
                                    f32 epsilon);
